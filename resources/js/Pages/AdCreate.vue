            ...
            <section class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <section>
                        ...
                        <section class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <template v-for="(attribute, index) in attributes.data" :key="attribute.id">
                                <div class="form-control"
                                    ...
                                    <label class="label w-fit after:content-['*'] after:ml-0.5 after:text-red-500"
                                           :for="attribute.id"
                    ...
                    <div class="form-control">
                        <label class="label">
                            <span
                                class="label-text font-bold after:content-['*'] after:ml-0.5 after:text-red-500">آدرس</span>
                        </label>
