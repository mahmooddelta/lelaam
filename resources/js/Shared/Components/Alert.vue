    ...
    <div class="fixed z-40 px-16 py-8" v-if="$page.props.flash.body && show">
        <div class="flex items-center justify-end max-w-3xl alert shadow-lg" :class="alertType">
            <div class="flex items-center">
                <svg v-if="$page.props.flash.type === 'success'" xmlns="http://www.w3.org/2000/svg"
                     class="stroke-current flex-shrink-0 mx-4 mr-2 w-6 h-6"
                     fill="none"
                     viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <svg v-else-if="$page.props.flash.type === 'info'" xmlns="http://www.w3.org/2000/svg"
                     class="stroke-current flex-shrink-0 mx-4 mr-2 w-6 h-6"
                     fill="none"
                     viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <svg v-else-if="$page.props.flash.type === 'warning'" xmlns="http://www.w3.org/2000/svg"
                     class="stroke-current flex-shrink-0 mx-4 mr-2 w-6 h-6"
                     fill="none"
                     viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
